...
import com.example.colabore.ui.history.HistoryContract
...
class HistoryNgoPresenter : HistoryNgoContract.Presenter {

    private var view: HistoryNgoContract.View? = null

    override fun loadHistory() {
        view?.displayLoading(false)
        db.collection("transacoes").whereEqualTo("cnpj", cpf().unmask()).get()
    ...
    override fun attachView(mvpView: HistoryNgoContract.View?) {
