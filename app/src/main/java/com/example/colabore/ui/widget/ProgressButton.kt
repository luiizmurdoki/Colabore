...
class ProgressButton @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) : FrameLayout(context, attrs, defStyle) {
        ...
        attrs?.let {
            ...
            if (progressColor != -1) {
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    progressButtonProgressBar.indeterminateDrawable.setColorFilter(context.getColor(progressColor), PorterDuff.Mode.SRC_IN)
                }
            }
            ...
            val textAllCaps = typedArray.getBoolean(R.styleable.ProgressButton_btnAllCaps, false)
    ...
    fun setBtnBackgroundColor(@ColorRes backgroundColor: Int) {
        ...
        coloredBgDrawable.setColorFilter(context.getColor(backgroundColor), PorterDuff.Mode.SRC_ATOP)
