...
import com.example.colabore.ui.history.HistoryAdapter
...
class HistoryNgoActivity :  BaseActivity(), HistoryNgoContract.View {
    private lateinit var auth: FirebaseAuth
    private val progressDialog = LoadingDialog()


    private val presenter: HistoryNgoContract.Presenter by lazy {
        HistoryNgoPresenter().apply { attachView(this@HistoryNgoActivity) }
    }
    ...
    private val historyAdapter by lazy {
        val adapter = HistoryNgoAdapter(this)
